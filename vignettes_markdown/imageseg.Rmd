...
```{r}
x <- imagesToKerasInput(images = img, type = "image", colorspace = "Gray")
...
The models are not perfect, but then it is a relatively small data set and we did not even do any data augmentation, which would almost certainly have improved predictions. 
